package com.es.portal.app.leave;
...
public class LeaveBizImpl extends BaseBiz implements LeaveBiz {
	...
	public ParamEntity myLeaves(ParamEntity paramEntity) throws Exception {
		...
		DataSet assignmentList = new DataSet(), assignmentListForApprover = new DataSet();

		try {
			assignmentList = wsClient.getLeaveAssignmentListDataSet(paramEntity, personId);
			assignmentListForApprover = wsClient.getLeaveAssignmentListForApproverDataSet(paramEntity, personId);

			paramEntity.setObject("assignmentList", assignmentList);
			paramEntity.setObject("assignmentListForApprover", assignmentListForApprover);
