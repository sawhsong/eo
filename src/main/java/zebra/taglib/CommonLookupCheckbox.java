...
public class CommonLookupCheckbox extends TaglibSupport {
	...
	public int doStartTag() {
		try {
			...
			ds = CommonLookupManager.getCodeDataSetByLookupType(codeType);
			...
			for (int i=0; i<ds.getRowCnt(); i++) {
				if (CommonUtil.toBoolean(isBootstrap, true)) {
					if (CommonUtil.equalsIgnoreCase(displayType, "block")) {
						...
						if (CommonUtil.containsIgnoreCase(disabledValue, ds.getValue(i, "LOOKUP_CODE")) || CommonUtil.equalsIgnoreCase(status, "disabled")) {html.append(" disabled");}
						html.append("\"><label");
						...
						html.append("><input type=\"checkbox\" id=\""+name+"_"+i+"\" name=\""+name+"\" value=\""+ds.getValue(i, "LOOKUP_CODE")+"\"");
						...
						if (CommonUtil.equals(ds.getValue(i, "LOOKUP_CODE"), selectedValue)) {html.append(" checked");}
						if (CommonUtil.containsIgnoreCase(disabledValue, ds.getValue(i, "LOOKUP_CODE")) || CommonUtil.equalsIgnoreCase(status, "disabled")) {html.append(" disabled");}
						...
						html.append("/>"+ds.getValue(i, "MEANING")+"</label></div>");
					} else {
						...
						html.append("/>"+ds.getValue(i, "MEANING")+"</label>");
					}
				} else {
					if (CommonUtil.equalsIgnoreCase(displayType, "block")) {
						html.append("<label class=\"lblCheck");
						if (CommonUtil.containsIgnoreCase(disabledValue, ds.getValue(i, "LOOKUP_CODE")) || CommonUtil.equalsIgnoreCase(status, "disabled")) {html.append("Dis");}
						else {html.append("En");}
						html.append(" block");
						if (CommonUtil.isNotBlank(labelClassName)) {html.append(" "+labelClassName+"");}
						html.append("\"");
						if (CommonUtil.isNotBlank(labelStyle)) {html.append(" style=\""+labelStyle+"\"");}
						html.append("><input type=\"checkbox\" id=\""+name+"_"+i+"\" name=\""+name+"\" value=\""+ds.getValue(i, "LOOKUP_CODE")+"\" class=\"chk");
						if (CommonUtil.containsIgnoreCase(disabledValue, ds.getValue(i, "LOOKUP_CODE")) || CommonUtil.equalsIgnoreCase(status, "disabled")) {html.append("Dis");}
						else {html.append("En");}
