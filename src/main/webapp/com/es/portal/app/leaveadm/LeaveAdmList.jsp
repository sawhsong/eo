...
<%
	...
	String defaultFromDate = CommonUtil.nvl(dsRequest.getValue("fromDate"), "");
	String defaultToDate = CommonUtil.nvl(dsRequest.getValue("toDate"), CommonUtil.getSysdate(dateFormat));
%>
<%/************************************************************************************************
* HTML
************************************************************************************************/%>
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="fromDate" class="lblEn hor">Date Range</label>
				<ui:text name="fromDate" className="Ct hor" value="<%=defaultFromDate%>" style="width:90px"/>
				<ui:icon id="icnFromDate" className="fa-calendar hor"/>
				<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
				<ui:text name="toDate" className="Ct hor" value="<%=defaultToDate%>" style="width:90px"/>
				<ui:icon id="icnToDate" className="fa-calendar hor"/>
			</td>
			<td class="tdSearch">
				<label for="leaveStatus" class="lblEn hor">Status</label>
				<div style="float:left;padding-right:4px;">
					<ui:ccselect name="leaveStatus" codeType="LEAVE_STATUS" caption="==Select=="/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="leaveType" class="lblEn hor">Type</label>
				<div style="float:left;padding-right:4px;">
					<ui:ccselect name="leaveType" codeType="LEAVE_TYPE" caption="==Select=="/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="leaveCategory" class="lblEn hor">Category</label>
				<div style="float:left;padding-right:4px;">
					<ui:ccselect name="leaveCategory" codeType="LEAVE_CATEGORY" caption="==Select=="/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="personName" class="lblEn hor">Person Name</label>
				<ui:text name="personName" className="Lt hor" style="width:150px"/>
			</td>
			<td class="tdSearch">
				<label for="personNumber" class="lblEn hor">Person Number</label>
				<ui:hidden name="personId"/>
				<ui:text name="personNumber" className="Lt hor" style="width:150px"/>
			</td>
		</tr>
	</table>
</div>
...
<div id="divDataArea" class="areaContainer">
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				<th class="thGrid"><ui:icon id="icnCheck" className="fa-check-square-o fa-lg" title="Select for Action"/></th>
				<th class="thGrid sortable:alphanumeric">Name</th>
