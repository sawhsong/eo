...
<%
	...
	DataSet dsAssignmentForApprover = (DataSet)pe.getObject("assignmentListForApprover");
%>
<%/************************************************************************************************
* HTML
************************************************************************************************/%>
...
%>
						...
						<optgroup label="Staff Assignments">
<%
							for (int i=0; i<dsAssignmentForApprover.getRowCnt(); i++) {
%>
								<ui:seloption value="<%=dsAssignmentForApprover.getValue(i, \"assignmentId\")%>" text="<%=dsAssignmentForApprover.getValue(i, \"assignmentName\")%>"/>
<%
							}
%>
						</optgroup>
