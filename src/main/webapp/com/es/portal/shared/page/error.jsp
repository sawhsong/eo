...
************************************************************************************************/%>
<script type="text/javascript" src="/com/es/portal/shared/resource/js/jquery/jquery-2.1.4.js"></script>
<style type="text/css">
body {
	padding:10px 10px;
...
<div class="errorCodeBox">
	<div class="errorIcon"><img src="/com/es/portal/shared/resource/image/icon/error.png"/></div>
